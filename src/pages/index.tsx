  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Construction tool rental v2 - Your one-stop solution for renting construction tools from a vast network of suppliers. Empowering individuals to build better."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Construction tool rental v2 - Your one-stop solution for renting construction tools from a vast network of suppliers. Empowering individuals to build better.`}
            </Text>
            <Box
